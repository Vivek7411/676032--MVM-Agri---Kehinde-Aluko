    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <main className="flex-1 overflow-y-auto pt-8">
        <div className="mx-auto max-w-6xl p-4 sm:p-6 lg:p-8">
          ...
          {/* ==================== LOGISTICS APPROVALS ==================== */}
          {activeItem === 'logistics-approvals' && (
            <Card className="border border-gray-200">
              <CardHeader className="pb-3">
                <CardTitle className="flex items-center gap-2 text-base font-semibold text-gray-900">
                  <Truck className="h-5 w-5" style={{ color: '#1D9E75' }} />
                  Logistics provider approvals
                </CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-gray-500 mb-4">Review and approve logistics providers before they can accept delivery orders on the platform.</p>
                <div className="overflow-x-auto">
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="border-b border-gray-100 text-left">
                        <th className="pb-2 pr-4 font-medium text-gray-500">Provider name</th>
                    ...
                    <tbody>
                      <tr className="border-b border-gray-50">
                        ...
                        <td className="py-3 pr-4 text-gray-500">5 days ago</td>
                        <td className="py-3">
                          <div className="flex gap-2">
                            <Button size="sm" className="h-7 bg-[#1D9E75] text-xs text-white hover:bg-[#0F6E56]">Approve</Button>
                            <Button size="sm" variant="outline" className="h-7 border-red-200 text-xs text-red-700 hover:bg-red-50">Reject</Button>
            ...
            <Card className="border border-gray-200">
              ...
              <CardContent>
                {productReviewMode === 'auto' && (
                  <div className="mb-4 rounded-lg border border-[#1D9E75]/20 bg-[#E1F5EE]/40 p-3">
                    <p className="text-xs text-[#0F6E56] font-medium">Auto-publish is enabled — new products will appear on the marketplace immediately without manual review.</p>
                  </div>
                )}
                <div className="overflow-x-auto">
                  <table className="w-full text-sm">
                    ...
                    <tbody>
                      ...
                      <tr className="border-b border-gray-50">
                        <td className="py-3 pr-4 font-medium text-gray-900">Tomatoes (Basket)</td>
                        <td className="py-3 pr-4 text-gray-500">Delta Agro Co.</td>
                        <td className="py-3 pr-4">
                          <Badge className="border-0 text-xs font-medium" style={{ backgroundColor: '#FEF3C7', color: '#92400E' }}>
                            Pending
                          </Badge>
                        </td>
                        <td className="py-3 pr-4 text-gray-500">500 kg</td>
                        <td className="py-3">
                          <div className="flex gap-2">
                            <Button size="sm" className="h-7 bg-[#1D9E75] text-xs text-white hover:bg-[#0F6E56]">Approve</Button>
                            <Button size="sm" variant="outline" className="h-7 border-red-200 text-xs text-red-700 hover:bg-red-50">Reject</Button>
